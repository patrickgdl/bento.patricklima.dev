          ...
          <div className="absolute flex items-center">
            <motion.span
              ...
              className={classNames(
                ...
                "relative pointer-events-none inline-block h-5 w-5 rounded-full bg-white dark:bg-gray-500 first-letter:shadow ring-0 transition duration-300 focus:outline-none"
              )}
            >
