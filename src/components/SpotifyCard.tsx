  ...
  return (
    ...
    >
      <div className="flex flex-col text-gray-900 dark:text-gray-100 justify-center xl:ml-7 md:ml-5 mt-5 xl:mt-none ml-4">
        <div className="text-[#62DBBE] lg:text-xl text-sm font-bold">
          Currently Listening
        </div>
      ...
      <div className="absolute text-[#62DBBE] fill-current top-0 left-0 m-2 md:m-5 rotate-20 hover:rotate-40 transition lg:w-[60px] lg:h-[60px] w-[30px] h-[30px]">
        <svg
          viewBox="0 0 256 256"
          version="1.1"
